<?php
    ...
    $id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT); //conforme o fabricante escolhido, esta linha passará a ter seu valor

    //Chamamos a função que irá retornar os dados de UM FABRICANTE
    $dados = lerUmFabricante($conexao, $id); // o id passa a ter o valor do fabricante escolhido
